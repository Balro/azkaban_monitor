package monitor.azkaban;

import monitor.azkaban.checker.CheckerEnum;
import monitor.azkaban.heartbeater.HeartBeater;
import monitor.azkaban.conf.ConfConst;
import monitor.azkaban.dispatcher.Dispacher;
import monitor.azkaban.sender.OneAlertSender;
...
public class AzkabanMonitor {
    ...
    private static void startChecker() throws Exception {
        ...
        initBDS();
        String pack = "monitor.azkaban.checker";
