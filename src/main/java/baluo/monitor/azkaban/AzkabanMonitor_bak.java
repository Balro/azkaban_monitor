...
//
//public class AzkabanMonitor_bak {
//    private static final Logger LOG = Logger.getLogger(AzkabanMonitor_bak.class);
//    private static Properties prop;
//    private ZKUtil zk;
//    private JDBCUtil jdbc;
//
//    public static void main(String[] args) throws Exception {
//        AzkabanMonitor_bak app = new AzkabanMonitor_bak();
//        app.init();
//        app.start();
//    }
//
...
//        LOG.info("AzkabanMonitor_bak initiallized.");
//    }
//
...
//                        if (flowNmae == null) {
//                            LOG.fatal("BaseEvent init failed: " + ce + ", flowName is null");
//                            System.exit(1);
//                        }
...
//                        if (jobName == null) {
//                            LOG.fatal("BaseEvent init failed: " + ce + ", jobName is null");
//                            System.exit(1);
//                        }
...
//                        break;
//                    default:
//                        LOG.error("BaseEvent init failed: " + ce + " 's type [" + type + "] is not valid.");
//                        System.exit(1);
//                }
//            }
...
//                for (CheckEvent ce : ceList) {
//                    try {
//                        List<SenderEvent> tmpSE = process(ce);
...
//        }
//
//        private List<SenderEvent> process(CheckEvent ce) throws Exception {
...
//                }
//                case "job": {
//                    List<SenderEvent> jobEvent = null;
//                    if (ce.startTime > 0) {
//                        if (ce.startTime >= ct.getTime(lastCheckTime) && ce.startTime < ct.getTime(System.currentTimeMillis())) {
...
//                }
//                default:
//                    LOG.warn("BaseEvent type [" + ce.type + "] not correct.");
//            }
//            return null;
//        }
//
...
//         */
//        private List<SenderEvent> hasFlowStarted(String flow, int expStartTime) throws Exception {
//            LOG.debug("check has flow started: " + flow);
//            List<SenderEvent> ses = new LinkedList<>();
...
//         */
//        private List<SenderEvent> hasFlowEnded(String flow, int expEndTime) throws Exception {
...
//         */
//        private List<SenderEvent> hasJobStarted(String job, int expStartTime) throws Exception {
...
//         */
//        private List<SenderEvent> hasJobEnded(String job, int expEndTime) throws Exception {
...
//         */
//        private List<SenderEvent> getFailedJobs(long lastCheckTime) throws Exception {
